...
document.getElementById("addEmployeesBtn").onclick = addemployees;
function addemployees() {

  const ArrayEmployees = []
  
  let EmployeePrompts = true
  while (EmployeePrompts) {
    ...
    EmployeePrompts = confirm("would you like to add another employee?");
  }
